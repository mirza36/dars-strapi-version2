...
export interface ApiPartQuizPartQuiz extends Struct.CollectionTypeSchema {
  collectionName: 'part_quizzes';
  info: {
    displayName: 'Part Quiz';
    pluralName: 'part-quizzes';
    singularName: 'part-quiz';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPartPart extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    part_quiz: Schema.Attribute.Relation<
      ...
      'api::part-quiz.part-quiz'
    >;
    PDF_Notes: Schema.Attribute.Media<'files'>;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
